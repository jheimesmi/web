...
-- 
-- Servidor: localhost
-- Tiempo de generación: 21-04-2013 a las 21:54:42
...
-- 
-- Estructura de tabla para la tabla 'web_admin_job'
-- 

CREATE TABLE web_admin_job (
  id int(11) NOT NULL auto_increment,
...
CREATE TABLE web_cert (
  ...
  resp11 text character set latin1 NOT NULL,
  resp12 text character set latin1 NOT NULL,
  resp13 text character set latin1 NOT NULL,
  fecha date default NULL,
  certificador varchar(36) character set latin1 default NULL,
  mensaje text character set latin1,
  suspende int(1) default NULL,
  finsus datetime default NULL,
  PRIMARY KEY  (id)
...
-- 
-- Estructura de tabla para la tabla 'web_cert2'
-- 

CREATE TABLE web_cert2 (
  id int(11) NOT NULL auto_increment,
  email text character set latin1 NOT NULL,
  resp1 text character set latin1 NOT NULL,
  resp2 text character set latin1 NOT NULL,
...
-- 
-- Estructura de tabla para la tabla 'web_noticias'
-- 
...
-- 
-- Estructura de tabla para la tabla 'web_perfiles'
-- 

CREATE TABLE web_perfiles (
  id int(11) unsigned NOT NULL auto_increment,
  email varchar(25) NOT NULL,
  `password` varchar(256) NOT NULL,
  nombre varchar(20) NOT NULL,
  certificacion int(2) NOT NULL default '0',
  ip varchar(30) NOT NULL,
  fondos int(11) unsigned NOT NULL default '0',
  idc1 int(11) unsigned NOT NULL default '0',
  namec1 varchar(24) NOT NULL default '0',
  idc2 int(11) unsigned NOT NULL default '0',
  namec2 varchar(24) NOT NULL default '0',
  idc3 int(11) unsigned NOT NULL default '0',
  namec3 varchar(24) NOT NULL default '0',
  idc4 int(11) unsigned NOT NULL default '0',
  namec4 varchar(24) NOT NULL default '0',
  idc5 int(11) unsigned NOT NULL default '0',
  namec5 varchar(24) NOT NULL default '0',
  UNIQUE KEY email (email,idc1,namec1,idc2,namec2,idc3,namec3,idc4,namec4,idc5,namec5),
  KEY id (id)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1;
